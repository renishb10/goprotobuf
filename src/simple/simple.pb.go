...
func (x *Simple) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *Simple) GetLastName() string {
	if x != nil {
		return x.LastName
	}
	return ""
...
var file_simple_proto_rawDesc = []byte{
	...
	0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x5f, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x22, 0x56,
	0x0a, 0x06, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x66, 0x69, 0x72, 0x73,
	...
	0x05, 0x52, 0x03, 0x61, 0x67, 0x65, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x3b, 0x73, 0x69, 0x6d, 0x70,
...
var file_simple_proto_goTypes = []interface{}{
	(*Simple)(nil), // 0: example_simple.Simple
}
